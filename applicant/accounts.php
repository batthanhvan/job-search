    ...
    <div class="container">
      ...
      <div class="form-group form-account">
        <div class="col-md-11">
          ...
          <div class="col-md-8">
            ...
            <textarea class="form-control input-sm" id="BIRTHPLACE" name="BIRTHPLACE" placeholder="Place of Birth" type="text" value="" required onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off"><?php echo $appl->BIRTHPLACE; ?></textarea>
          </div>
        </div>
      </div>
      ...
      <div class="form-group form-account">
        <div class="col-md-11">
          ...
          <div class="col-md-8">
            ...
            <input class="form-control input-sm" id="TELNO" name="TELNO" placeholder="Contact Number" type="text" any value="<?php echo $appl->CONTACTNO; ?>" required onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
          </div>
        </div>
      </div>
      ...
      <div class="form-group form-account">
        <div class="col-md-11">
          ...
          <div class="col-md-8">
            <input class="form-control input-sm" id="DEGREE" name="DEGREE" placeholder="Educational Attainment" onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off" value="<?php echo $appl->DEGREE; ?>">
          </div>
        </div>
      </div>
      <div class="form-group form-account">
