    ...
    <div class="container content">
        ...
        <table id="dash-table" class="table table-hover">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM `company` c,`job` j WHERE c.`COMPANYID`=j.`COMPANYID` AND COMPANYNAME LIKE '%" . $COMPANYNAME . "%' ORDER BY DATEPOSTED DESC";
                $mydb->setQuery($sql);
        ...
        // }
        //    $sql = "SELECT * FROM `company` c,`job` j WHERE c.`COMPANYID`=j.`COMPANYID` AND c.COMPANYID LIKE '%" . $companyid ."%' ORDER BY DATEPOSTED DESC" ;
        //    $mydb->setQuery($sql);
        //    $cur = $mydb->loadResultList();
